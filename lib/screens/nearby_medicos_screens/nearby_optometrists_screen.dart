...
class NearbyOptometrists extends StatefulWidget {

  @override
  _NearbyOptometristsState createState() => _NearbyOptometristsState();
}

class _NearbyOptometristsState extends State<NearbyOptometrists> {
            ...
            children: <Widget>[
              ...
              IconButton(
                ...
                onPressed: !webViewReady
                    ? null
                    : () {
                  globalWebViewController.loadUrl('https://www.google.com/maps/search/optometrist/');
                },
              ),
              IconButton(
                color: kAmberColor,
