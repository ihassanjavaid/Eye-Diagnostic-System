...
class VisualAcuityInstructionsScreen extends StatefulWidget {
  static const String id = 'visual_acuity_instructions_screen';

  @override
  _VisualAcuityInstructionsScreen createState() => _VisualAcuityInstructionsScreen();
}

class _VisualAcuityInstructionsScreen extends State<VisualAcuityInstructionsScreen> {
                    ...
                    child: PageView(
                      ...
                      children: <Widget>[
                        buildPageViewBlock(
                            'Visual Acuity Test',
                            'Instructions',
                            'This test checks the eyes\'s ability to discern different objects and outlines, determining your overall vision health. Please read the following instructions carefully for accurate results',
                        ...
                        buildPageViewBlock(
                            'Step 6.',
                            'Take the Test',
                            'You will be shown decreasing sizes of the letter \'E\'. By tapping on arrows, you must distinguish the open face direction of the letter. As shown above, the open faces are down, right, up, left respectively.',
                            'assets/images/vision_testing/instructions_icons/tumbling-e.png'),
                      ],
                    ),
                  ),
                  SizedBox(
