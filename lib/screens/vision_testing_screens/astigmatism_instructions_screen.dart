...
class AstigmatismInstructionsScreen extends StatefulWidget {
  static const String id = 'astigmatism_instructions_screen';

  @override
  _AstigmatismInstructionsScreen createState() => _AstigmatismInstructionsScreen();
}

class _AstigmatismInstructionsScreen extends State<AstigmatismInstructionsScreen> {
                    ...
                    child: PageView(
                      ...
                      children: <Widget>[
                        buildPageViewBlock(
                            'Astigmatism Test',
                            'Instructions',
                            'Astigmatism is the imperfect curvature of the cornea. This test checks if your corneas are capable of converging light, and seeing clearer images. Please read the following instructions carefully.',
                        ...
                        buildPageViewBlock(
                            'Step 6.',
                            'Take the Test',
                            'During this test you will see images with lines. Please use the relevant buttons to indicate whether all the lines appear equally clear and equally black, or blurry.',
                            'assets/images/vision_testing/instructions_icons/eye-scan.png'),
                      ],
                    ),
                  ),
                  SizedBox(
